...
let DashboardController = class DashboardController {
    ...
    async getRecentOrders(req, limit) {
        return this.dashboardService.getRecentOrders(req.user.id, limit ? parseInt(limit) : 10);
    }
    async getMyAgentsPerformance(req) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DashboardController.prototype, "getMyAgentsPerformance", null);
