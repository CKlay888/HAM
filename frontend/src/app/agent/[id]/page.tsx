      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  {agent.isFeatured && (
                    <span className="px-2 py-0.5 bg-gradient-to-r from-orange-400 to-pink-500 text-white text-xs rounded-full font-medium">
                      精选
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm">
                  ...
                  <span className="text-gray-400">|</span>
                  <span className="text-gray-600">基于 {agent.modelBase}</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {agent.capabilities.map((cap) => (
                <span key={cap} className="px-3 py-1.5 bg-blue-50 text-blue-700 text-sm rounded-lg">
                  ✓ {cap}
                </span>
              ))}
            </div>
                ...
                <div key={review.id} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <button className="text-gray-400 text-sm mt-2 hover:text-blue-600">
                        👍 有用 ({review.helpful})
                      </button>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-gray-200 p-6 sticky top-24">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">💰 选择方案</h2>
            ...
            <div className="space-y-3 mb-6">
              {mockPricingPlans.map((plan) => (
                ...
                >
                  {plan.isRecommended && (
                    <span className="absolute -top-2 right-3 px-2 py-0.5 bg-blue-600 text-white text-xs rounded-full">
                      推荐
                    </span>
                  )}
            ...
            <button className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:opacity-90 transition-opacity mb-3">
              立即购买
            </button>
